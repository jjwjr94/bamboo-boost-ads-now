...
const Hero = () => {
  ...
  return (
    <div className="relative pt-24 pb-16 px-4 overflow-hidden">
      ...
      {/* Background Image - Using inline SVG instead of reference */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full h-full max-w-6xl">
          <svg width="100%" height="100%" viewBox="0 0 1500 855" fill="none" xmlns="http://www.w3.org/2000/svg">
            <style>
              {`
              /* Slide Up animation */
              @keyframes slideUp {
              ...
              g[clip-path="url(#clip1_381_93)"] {
                animation:
                  ...
                  sway 6s ease-in-out infinite 2.0s; /* Sway starts after slideUp */
                transform-origin: center bottom; /* Keep for sway */
              }

              g[clip-path="url(#clip2_381_93)"] {
                animation:
                  slideUp 2.2s ease-out forwards,
                  sway 6s ease-in-out infinite 2.2s;
            ...
            <g clipPath="url(#clip0_381_93)">
              <g clipPath="url(#clip1_381_93)">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M29.1552 775.992C28.0372 770.836 33.1611 766.539 38.0477 768.535L65.0003 779.544C77.0935 782.413 90.7975 791.304 102.088 804.751C121.445 827.807 126.38 855.519 113.111 866.646C99.8417 877.773 73.3931 868.104 54.0361 845.048C43.6432 832.67 37.4094 818.949 35.9165 807.173L29.1552 775.992ZM51.0146 796.234L94.7606 848.338L99.1998 844.615L55.4538 792.511L51.0146 796.234Z" fill="#00C39C"/>
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M313.403 76.9561C314.521 71.8 309.397 67.5029 304.511 69.4987L277.558 80.5078C265.465 83.377 251.761 92.2678 240.47 105.715C221.113 128.771 216.178 156.483 229.447 167.61C242.717 178.737 269.165 169.068 288.522 146.012C298.915 133.634 305.149 119.913 306.642 108.137L313.403 76.9561ZM291.544 97.1979L247.798 149.302L243.358 145.579L287.104 93.4752L291.544 97.1979Z" fill="#00C39C"/>
                <path d="M215.247 241.607H128.323V40.3497H215.247V241.607Z" fill="#00C39C"/>
                <path d="M128 26.459L215.221 15.9151V124.227H128V26.459Z" fill="#00C39C"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M313.403 539.957C314.521 534.8 309.397 530.503 304.511 532.499L277.558 543.508C265.465 546.377 251.761 555.268 240.47 568.716C221.113 591.771 216.178 619.483 229.447 630.611C242.717 641.738 269.165 632.068 288.522 609.013C298.915 596.634 305.149 582.913 306.642 571.138L313.403 539.957ZM291.544 560.198L247.798 612.303L243.358 608.58L287.104 556.476L291.544 560.198Z" fill="#00C39C"/>
              ...
              <g clipPath="url(#clip2_381_93)">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M721.104 13.662C722.49 8.57141 717.598 4.01211 712.614 5.74944L685.122 15.3328C672.895 17.5651 658.745 25.7265 646.766 38.5648C626.229 60.5757 619.85 87.9911 632.519 99.7979C645.187 111.604 672.106 103.332 692.643 81.3213C703.669 69.5035 710.613 56.1277 712.72 44.4465L721.104 13.662ZM698.215 32.732L651.802 82.4753L647.564 78.5253L693.977 28.782L698.215 32.732Z" fill="#00C39C"/>
                <path d="M614.464 172.95L527.659 168.401L538.192 -32.5807L624.997 -28.0314L614.464 172.95Z" fill="#00C39C"/>
                <path d="M538.597 -46.4693L626.251 -52.4339L620.582 55.7299L533.48 51.165L538.597 -46.4693Z" fill="#00C39C"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M696.872 476.027C698.259 470.937 693.367 466.377 688.382 468.115L660.89 477.698C648.664 479.93 634.513 488.092 622.534 500.93C601.997 522.941 595.619 550.356 608.287 562.163C620.956 573.969 647.874 565.697 668.411 543.686C679.438 531.869 686.381 518.493 688.488 506.812L696.872 476.027ZM673.984 495.097L627.571 544.84L623.332 540.891L669.745 491.147L673.984 495.097Z" fill="#00C39C"/>
              ...
              <g clipPath="url(#clip3_381_93)">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M804.343 776.561C803.045 771.447 808.016 766.974 812.969 768.798L840.29 778.86C852.476 781.305 866.482 789.712 878.235 802.758C898.385 825.124 904.283 852.646 891.411 864.23C878.538 875.814 851.768 867.073 831.618 844.707C820.8 832.699 814.091 819.204 812.188 807.488L804.343 776.561ZM826.895 796.028L872.433 846.574L876.739 842.698L831.202 792.153L826.895 796.028Z" fill="#00C39C"/>
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M1064.02 68.0298C1064.96 62.8378 1059.69 58.7222 1054.87 60.8873L1028.32 72.8303C1016.34 76.1197 1002.95 85.4834 992.137 99.3168C973.596 123.034 969.631 150.901 983.28 161.559C996.93 172.216 1023.02 161.629 1041.57 137.912C1051.52 125.178 1057.27 111.248 1058.35 99.4279L1064.02 68.0298ZM1042.88 89.0221L1000.98 142.621L996.414 139.056L1038.32 85.4566L1042.88 89.0221Z" fill="#00C39C"/>
                <path d="M971.671 236.006L884.799 239.04L877.776 37.9047L964.647 34.8711L971.671 236.006Z" fill="#00C39C"/>
                <path d="M876.968 24.0337L963.769 10.4522L967.549 118.698L880.38 121.742L876.968 24.0337Z" fill="#00C39C"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M1080.18 530.748C1081.12 525.556 1075.85 521.44 1071.03 523.605L1044.48 535.548C1032.49 538.838 1019.11 548.201 1008.3 562.035C989.754 585.752 985.79 613.619 999.439 624.276C1013.09 634.934 1039.18 624.347 1057.72 600.63C1067.68 587.896 1073.43 573.966 1074.51 562.146L1080.18 530.748ZM1059.04 551.74L1017.14 605.339L1012.57 601.773L1054.47 548.174L1059.04 551.74Z" fill="#00C39C"/>
              ...
              <g clipPath="url(#clip4_381_93)">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M1170.16 775.993C1169.04 770.837 1174.16 766.54 1179.05 768.536L1206 779.545C1218.09 782.414 1231.8 791.30
